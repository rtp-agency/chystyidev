...
export type CaseStudy = {
  ...
  lead: string;
  /**
   * Short <title> for search results. Google truncates around 60 characters
   * including the " · David Chystyi" suffix, so headline-length titles get a
   * trimmed variant here. Falls back to `title` when absent.
   */
  metaTitle?: string;
...
export const cases: CaseStudy[] = [
...

  {
    ...
    metaTitle: "Automated Video Editing at Scale",
    metaDescription:
...

  {
    ...
    metaTitle: "Metra AI — Production Multi-Agent SaaS",
    metaDescription:
...

  {
    ...
    metaTitle: "Lipsync System — 99%+ Cost Cut",
    metaDescription:
...

  {
    ...
    metaTitle: "Motion Control — 84% Cost Cut",
    metaDescription:
